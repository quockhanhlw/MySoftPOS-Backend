-- Flyway V5 hotfix: recover environments where V4 was skipped/baselined.
-- Idempotent: safely adds/aligns merchant multi-account columns and relation.
